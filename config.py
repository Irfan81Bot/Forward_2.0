...
class Config:
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6203745359:AAF1wBkWDa0DY-nGqjVmtJ8Cox4pDJh825E") 
    BOT_SESSION = os.environ.get("BOT_SESSION", "Forward_BOT1") 
    ...
    COLLECTION_NAME = os.environ.get('COLLECTION_NAME', 'Forward_data1')
    ...
    BOT_USERNAME= os.environ.get("BOT_USERNAME", "Auto_Forword_2Bot")
